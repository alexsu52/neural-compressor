...
class MxNetAdaptor(Adaptor):
    ...
    def evaluate(self, lpot_model, data_x, postprocess=None,
        ...
        sym_model, dataloader = prepare_model_data(lpot_model, self.ctx, data_x)
    ...
    def query_fw_capability(self, lpot_model):
        ...
        Args:
            lpot_model (object): model to query.
    ...
    def inspect_tensor(self, lpot_model, data_x, op_list=[], iteration_list=[],
                       inspect_type='activation', save_to_disk=False):
        """The function is used by tune strategy class for dumping tensor info.

        Args:
            lpot_model (object): The model to do calibration.
            data_x (object): Data iterator/loader.
        ...
        tensor_dict_list = self._inspect_tensor(lpot_model, data_x, op_list, iteration_list)
